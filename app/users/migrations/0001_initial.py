    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=128, validators=[django.core.validators.RegexValidator(message="Parol kamida 8 ta belgidan iborat bo'lishi kerak :\n            - kamida 1 ta katta harf \n            - kamida 1 ta kichik hark\n            - kamida 1 ta raqam\n            - maxsus belgilar ruxsat etilmaydi.\n        ", regex='^(?=.*[A-Za-z])(?=.*\\d)[A-Za-z\\d]{8,}$')], verbose_name='parol')),
